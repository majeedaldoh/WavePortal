...
const App = () => {
    ...
    const [usersmessage,setmessage]=useState("");
    const contractAddress = "0x84f551C3bb706fF5D427844ff2E4565F6cFEb27c";
    ...
    const wave = async () => {
        try {
            ...
            if (ethereum) {
                 ...
                 */
                const waveTxn = await wavePortalContract.wave(usersmessage, { gasLimit: 300000 });
